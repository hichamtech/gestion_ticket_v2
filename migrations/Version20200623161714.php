 ...
 */
final class Version20200623161714 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, technicien_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, status TINYINT(1) NOT NULL, priorite VARCHAR(255) NOT NULL, date DATETIME NOT NULL, INDEX IDX_97A0ADA313457256 (technicien_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
